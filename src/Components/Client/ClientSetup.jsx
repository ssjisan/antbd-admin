...
export default function ClientSetup() {
  ...
  const canCreate = hasPermission(auth?.permissions, "client", "canCreate");
  const canUpdate = hasPermission(auth?.permissions, "client", "canUpdate");
  const canDelete = hasPermission(auth?.permissions, "client", "canDelete");
