        ...
        <form onSubmit={handleSubmit}>
          <Stack spacing={3}>
            ...
            <Box>
                  ...
                  <Stack key={i} direction="row" spacing={1}>
                    ...
                    {canDelete && emails.length > 1 && (
                      <IconButton color="error" onClick={() => removeEmail(i)}>
                        <Icon name="remove" color="red" size="20px" />
                      </IconButton>
                    )}
                  </Stack>
                ))}
              ...
              {canCreate && (
                <Button
                  startIcon={<Icon name="plus" color="#792df8" size="20px" />}
                  onClick={addEmail}
                  size="small"
                  sx={{ mt: 1 }}
                >
            ...
            <Box>
              ...
              <Stack spacing={1}>
                {phoneNumbers.map((phone, i) => (
                  <Stack key={i} direction="row" spacing={1}>
                    ...
                    {canDelete && phoneNumbers.length > 1 && (
              ...
              {canCreate && (
                <Button
                  startIcon={<Icon name="plus" size="20px" color="#792df8" />}
                  onClick={addPhone}
                  size="small"
                  sx={{ mt: 1 }}
                >
